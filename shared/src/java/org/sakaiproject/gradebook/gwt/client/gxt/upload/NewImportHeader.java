...
public class NewImportHeader implements Serializable, Comparable<NewImportHeader> {
	...
	public enum Field { S_ID, S_NAME, S_CRS_GRD, S_LTR_GRD, S_CALC_GRD, S_ADT_GRD, S_GRB_OVRD, S_ITEM, S_COMMENT, S_BLANK }
	...
	public NewImportHeader() {

	}

	public NewImportHeader(Field field, String value, int columnIndex) {
		this.field = field;
		this.value = value;
		this.columnIndex = columnIndex;
	}

	public NewImportHeader(String header, int columnIndex) {
		this.headerName = header;
		this.columnIndex = columnIndex;
	}

	public NewImportHeader(String assignmentId, String headerName, Mode mode, Double numericValue) {

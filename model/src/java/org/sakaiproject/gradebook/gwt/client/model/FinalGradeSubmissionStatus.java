...
public interface FinalGradeSubmissionStatus {
	
	public String getDialogNotificationMessage();
	
	public void setDialogNotificationMessage(String message);
	
	public String getBannerNotificationMessage();
	
	public void setBannerNotificationMessage(String message);

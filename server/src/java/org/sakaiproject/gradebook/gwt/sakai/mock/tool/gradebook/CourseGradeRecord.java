/**********************************************************************************
*
* $Id: CourseGradeRecord.java 41496 2008-02-21 16:38:26Z lance@indiana.edu $
*
***********************************************************************************
*
...
public class CourseGradeRecord extends AbstractGradeRecord {
	...
	public void initNonpersistentFields(double totalPointsPossible, double totalPointsEarned) {
		...
		if (totalPointsPossible == 0.0) {
			...
			percentageEarned = new Double(bdTotalPointsEarned.divide(bdTotalPointsPossible, MATH_CONTEXT).multiply(new BigDecimal("100")).doubleValue());
		}

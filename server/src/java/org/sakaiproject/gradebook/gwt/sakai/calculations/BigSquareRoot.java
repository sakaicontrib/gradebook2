 ...
 * 
 * The author provides the following message in place of a license:
 ...
 * Note that, when computing very large square roots, you should use a large scale. For numbers 
 * of 100 digits, I use a scale of 50."
 *
 */

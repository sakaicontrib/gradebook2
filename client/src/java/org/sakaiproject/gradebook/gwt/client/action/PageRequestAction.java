...
public class PageRequestAction extends Action {

	private static final long serialVersionUID = 1L;

	public PageRequestAction() {
		super();
	}

	public PageRequestAction(EntityType entityType, String gradebookUid, Long gradebookId) {

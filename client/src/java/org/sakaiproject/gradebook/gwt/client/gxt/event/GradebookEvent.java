...
public class GradebookEvent {
	...
	public enum EventKey { NONE(-1), BEGIN_ITEM_UPDATES(14000), BROWSE_LEARNER(14001), 
		...
		CLOSE_NOTIFICATION(14004), CREATE_ITEM(14005), DELETE_GRADE_MAP(19006), 
		DELETE_ITEM(14006), DO_SEARCH(12007), 
		END_ITEM_UPDATES(14007), EQUL_WEIGHT(14008), EXCEPTION(15000), EXPAND_EAST_PANEL(14009), 
		FAILED_TO_UPDATE_ITEM(14010),
		GRADEBOOK_CHANGE(14011), GRADE_TYPE_UPDATED(14012), HIDE_COLUMN(14015), HIDE_EAST_PANEL(14060), HIDE_FORM_PANEL(15020), 
		...
		UPDATE_LEARNER_GRADE_RECORD(14070), UPDATE_GRADE_MAP(14073), UPDATE_ITEM(14075), USER_CHANGE(14090), 

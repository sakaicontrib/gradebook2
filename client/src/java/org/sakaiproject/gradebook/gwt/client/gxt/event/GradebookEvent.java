...
public class GradebookEvent {
	...
	public enum EventKey { 
		...
		EXCEPTION, EXPAND_EAST_PANEL, FAILED_TO_UPDATE_ITEM,
		GRADEBOOK_CHANGE, GRADE_TYPE_UPDATED, HIDE_COLUMN, HIDE_EAST_PANEL, HIDE_FORM_PANEL, 
		ITEM_CREATED, ITEM_DELETED, ITEM_UPDATED, LEARNER_GRADE_RECORD_UPDATED, 
		LOAD, LOAD_ITEM_TREE_MODEL, MASK_ITEM_TREE, NEW_CATEGORY, 
		...
		SWITCH_GRADEBOOK, UNMASK_ITEM_TREE, 
